  ...
  return (
    ...
    <div style={{padding:'80px 0'}}>
     <div>
       ...
       <center><p style={{fontFamily:'Montserrat, system-ui',fontSize:'18px',fontWeight:'400',margin:'0',paddingBottom:'40px',color:'#00000080'}}>Painted canvases are unique gifts that convey deep emotions and memories. Add a personal touch to your special occasion <br />
